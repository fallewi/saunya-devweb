...
class ProductController extends Controller
{
    ...
    public function admin_products(Request $request)
    {
        ...
        $products = Product::where('added_by', 'admin')->where('is_service',false);
    ...
    public function seller_products(Request $request)
    {
        ...
        $seller_id = null;
        $sort_search = null;
        $products = Product::where('added_by', 'seller')->where('is_service',false);
    ...
    public function seller_services(Request $request)
    {
        ...
        $seller_id = null;
        $sort_search = null;
        $products = Product::where('added_by', 'seller')->where('is_service',true);
        if ($request->has('user_id') && $request->user_id != null) {
            $products = $products->where('user_id', $request->user_id);
            $seller_id = $request->user_id;
        }
    ...
    public function all_products(Request $request)
    {
        ...
        $seller_id = null;
        $sort_search = null;
        $products = Product::where('is_service',false)->orderBy('created_at', 'desc');
        if ($request->has('user_id') && $request->user_id != null) {
            $products = $products->where('user_id', $request->user_id);
            $seller_id = $request->user_id;
        }
    ...
    //  ajout du controleur de récupération des services
     public function all_services(Request $request)
     {
         ...
         $seller_id = null;
         $sort_search = null;
         $products = Product::Where('is_service', true)->orderBy('created_at', 'desc');
         if ($request->has('user_id') && $request->user_id != null) {
             $products = $products->where('user_id', $request->user_id);
             $seller_id = $request->user_id;
         }
    ...
    {
        $categories = Category::where('parent_id', 0)->where('is_service',false)
            ->where('digital', 0)
    ...
    // sauvegarde du produit ou service en bd
     ...
     */
     public function admin_product_edit(Request $request, $id)
     {
        ...
        $categories = Category::where('is_service',false)
            ->where('digital', 0)
            ->with('childrenCategories')
            ->get();
