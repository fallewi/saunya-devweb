...
class ProductController extends Controller
{
    ...
    {
        return new ProductMiniCollection(Product::where('added_by', 'seller')->latest()->paginate(10));
    }
    ...
    {
        return new ProductMiniCollection(Product::where('brand_id', $id)->latest()->paginate(10));
    }
    ...
    {
        $product = Product::find($id);
        return new ProductMiniCollection(Product::where('user_id', $product->user_id)->orderBy('num_of_sale', 'desc')->limit(4)->get());
    }
