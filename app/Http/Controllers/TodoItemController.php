...
class TodoItemController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('booking.admin.todo-list.index');
    }

    public function create(Request $request)
    {
        return view('booking.do-list.todo-item-create');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('booking.admin.todo-list.todo-item-edit', compact('todoItem'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (request()->server('HTTP_REFERER') == route('dashboard')) {
