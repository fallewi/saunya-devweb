...
Route::prefix('v1')->group(function () {
    ...
    Route::apiResource('wishlists', 'Api\WishlistController')->except(['index', 'update', 'show','isProductInWishlist'])->middleware('auth:api');
...
Route::prefix('v2')->group(function () {
    ...
    Route::post('user/info/updatephone', 'Api\V2\UserController@updatePhone')->middleware('auth:api');
