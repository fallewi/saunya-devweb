                                    ...
                                    <section class="mt-3 mb-3">
                                        <form class="form-horizontal ajax-form" id="front-theme-form" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <h6 class="col-md-12 text-primary">@lang('modules.theme.subheadings.colorPallette')</h6>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>@lang('modules.theme.primaryColor')</label>
                                                            <input type="text" class="form-control color-picker"
                                            ...
                                            <div class="row mb-3">
                                                <h6 class="col-md-12 text-primary">@lang('modules.theme.subheadings.customCss')</h6>
...
@push('footer-js')
    ...
    <script>
        ...
        $('#save-seo-settings').click(function () {
