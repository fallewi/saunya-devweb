...
<!-- barre de navigation du frontent -->
        ...
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto col-xl-3 pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block py-20px mr-5 ml-0" href="{{ route('home') }}">
                     
                     <!-- recupère le logo enregistré ou alors défini dans le  assets/img/logo.png -->
                        @php
                    ...
                    <!--  au clique sur le logo redirige sur la home page -->
                ...
                <!-- formulaire de recherche de du frontend -->
