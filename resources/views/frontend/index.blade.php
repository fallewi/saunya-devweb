    ...
    <div class="home-banner-area mb-4 pt-3">
        <div class="container">
            ...
            @php
                ...
                @endphp
            <!-- slider sur la page d'accueil du site -->
                   ...
                   <div class='col-lg-9'>
                        <ul class="list-unstyled mb-0 row gutters-5">
                            @foreach ($featured_categories as $key => $category)
                                <li class=" col-lg-3minw-0 col-4 col-md mt-3">
        ...
        <!-- bloc de la page d'accueil sité en haut sur le coté droit et servant à montrer les ventes flash du jour -->
...
<!-- fin du bloc -->
    ...
    {{-- Best Seller --}}
    <!-- ajout du bloc meilleur vendeur du le front page -->
    @if (\App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
    <div id="section_best_sellers">

    </div>
    @endif
    <!-- ajout du bloc Top 10 des catégories -->
