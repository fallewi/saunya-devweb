                        ...
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6 text-right">
                                    ...
                                    @endphp
                                    @if ($qty > 0 && $detailedProduct->is_service == false )
                                        <span class="badge badge-md badge-inline badge-pill badge-success">{{ translate('In stock')}}</span>
                                    @elseif ($qty == 0 && $detailedProduct->is_service == true )
                                        <span class="badge badge-md badge-inline badge-pill badge-success">{{ translate('Possible to Book this Service')}}</span>
                                    @else
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="product-quantity d-flex align-items-center">
                                            ...
                                            @if ($detailedProduct->is_service == false)
...
<!-- ----------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
                            <div class="mt-3">
                                ...
                                @elseif ($qty == 0 && $detailedProduct->is_service == true)
                                <button type="button" class="btn btn-soft-primary mr-2 add-cart fw-600" onclick="addToCart()">
                                    <i class="las la-shopping-bag"></i>
                                    <span class="d-none d-md-inline-block"> {{ translate('Add to cart')}}</span>
                                </button>
                                <button type="button" class="btn btn-primary book-now fw-600" onclick="">
                                    <i class="la la-shopping-cart"></i> {{ translate('Book Now')}}
                                </button>
                                @else
